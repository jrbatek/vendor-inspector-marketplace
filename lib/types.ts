export type InspectorType = "Independent" | "Agency" | "Company Employee";
...
export type CertificationReference = ReferenceItem & { issuing_body: string | null };
export type CodeStandardReference = ReferenceItem & { publisher: string | null };
