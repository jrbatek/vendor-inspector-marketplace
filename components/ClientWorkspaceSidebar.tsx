...
export default function ClientWorkspaceSidebar({demo=false}:{demo?:boolean}){
  ...
  return <aside className="clientSide">
    ...
    <Link className="primary" href={requestHref}>Request Inspectors</Link>
    <div className="subnav">
      <Link className={active("/find-inspectors")?"active":""} href={naturalHref}>Natural language</Link>
      <Link className={active("/email-requirements")?"active":""} href={emailHref}>Email requirements</Link>
      <Link className={active("/inspectors")?"active":""} href={structuredHref}>Structured selection</Link>
    </div>
    <Link href={activeHref}>Inspections in Progress</Link>
    <Link href={historyHref}>Inspection History</Link>
    <Link href={analyticsHref}>Analytics</Link>
    <Link href={billingHref}>Billing & Payment</Link>
    <Link href={contractsHref}>Contracts</Link>
