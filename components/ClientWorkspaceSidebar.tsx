...
export default function ClientWorkspaceSidebar({demo=false}:{demo?:boolean}){
  ...
  return <aside className="clientSide">
    ...
    <div className="subnav"><Link href={naturalHref}>Natural language</Link><Link href={emailHref}>Email requirements</Link><Link href={structuredHref}>Structured selection</Link></div>
