...
export default function ClientWorkspaceSidebar({demo=false}:{demo?:boolean}){
  ...
  return <aside className="clientSide">
    ...
    <div className="subnav"><Link className={activePath("/find-inspectors")?"active":""} href={naturalHref}>Natural language</Link><Link className={activePath("/email-requirements")?"active":""} href={emailHref}>Email requirements</Link><Link className={activePath("/inspectors")?"active":""} href={structuredHref}>Structured selection</Link></div>
    <Link className={progressActive?"active":""} href={activeHref}>Inspections in Progress</Link><Link className={historyActive?"active":""} href={historyHref}>Inspection History</Link><Link className={analyticsActive?"active":""} href={analyticsHref}>Analytics</Link><Link className={billingActive?"active":""} href={billingHref}>Billing & Payment</Link><Link className={contractsActive?"active":""} href={contractsHref}>Contracts</Link><Link className={profileActive?"active":""} href={profileHref}>Profile</Link>
